...
@section('content')
    ...
    <section class="container">
      <div class="herosection row">
        ...
        <span class="section-overlay d-flex flex-column align-items-center">
          ...
          <h3>Get to know more about Expeditions !</h3>
    ...
    <section class="container">
      <div class="d-flex flex-column justify-content-center my-5">
        ...
        <div id="cardsSectioncontent" class="d-flex justify-content-center row">
          @foreach($blogpostcategories as $post)
              <div class="card mx-4 cardcustom col-md-3 my-4 col-sm-11">
                  <div class="cardimage">
                      <img class="card-img-top" style="width: 100%; object-fit:cover;" src="{{ asset('uploads/blogpostcategory/' . $post->image) }}" alt="Card image cap"/>
                  </div>
                  <div class="card-body">
